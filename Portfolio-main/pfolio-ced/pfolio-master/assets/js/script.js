...
// Navbar active link switching for both desktop and mobile
...
const navToggleBtnMobile = document.querySelector('.nav-toggle');
const navMobile = document.querySelector('nav');

if (navToggleBtnMobile && navMobile) {
  navToggleBtnMobile.addEventListener('click', function() {
